...
class Watch:
    ...
    def toggleSale(self):
        return Seq([
            ...
            If(App.globalGet(self.Variables.sale) == Int(0)).Then(App.globalPut(
                self.Variables.sale, Int(1))).Else(App.globalPut(self.Variables.sale, Int(0))),
            Approve()
        ])
    ...
    def application_start(self):
        return Cond(
            ...
            [Txn.application_args[0] == self.AppMethods.changedescription,
